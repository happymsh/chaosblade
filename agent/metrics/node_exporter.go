...
var MetricsHandler handler
var runFunc = run

//for the bug :Fix conflict with standard flag package on testing #194
//https://github.com/alecthomas/kingpin/pull/194
func run(args []string) {
	//log.AddFlags(kingpin.CommandLine)
	//kingpin.Version(version.Print("node_exporter"))
	//kingpin.HelpFlag.Short('h')
	var empty []string
	_, _ = kingpin.CommandLine.Parse(empty)
	//kingpin.Parse()
}

func init() {
	runFunc(os.Args[1:])
	MetricsHandler = *newHandler(false, 40)
}
...
//func main() {
//	http.Handle("/metrics", newHandler(false, 40))
